...
public class ChatAdapter extends BaseListAdapter<Msg> {
    ...
    public View bindView(final int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout ll_news_list = (LinearLayout) convertView.findViewById(R.id.ll_news_list);//新闻列表
        ImageView iv_news_top_img = (ImageView) convertView.findViewById(R.id.iv_news_top_img);//新闻图片
        TextView tv_news_top_title = (TextView) convertView.findViewById(R.id.tv_news_top_title);//新闻标题
